/*  linreg.h
    ...
    LinearRegression1 to get values.
...
{
    friend ostream& operator<<(ostream& out, LinearRegression1& lr);

    public:
        // Constructor using an array of Point2D objects
        // This is also the default constructor
        LinearRegression1(Point2D *p = 0, long size = 0);

        // Constructor using arrays of x values and y values
        LinearRegression1(double *x, double *y, long size = 0);
