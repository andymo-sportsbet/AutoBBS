...
static AsirikuyReturnCode loadDailyIndicators(StrategyParams* pParams, Base_Indicators* pIndicators)
{
	...
	double preDayClose = iClose(B_DAILY_RATES, 1);
	double preDay2Close = iClose(B_DAILY_RATES, 2);
